					...
					<div class="nk-block nk-block-lg">
						<div class="nk-block-head">
							...
							<div class="nk-block-head-content">
								<h4 class="title nk-block-title">Update Model Details</h4>
						...
						<div class="card card-bordered">
							<div class="card-inner">
								...
								<form method="post" enctype="multipart/form-data" action="{{url('models/edit')}}/{{$data->id}}">
									...
									<div class="row g-4">
										...
										<div class="col-xl-12 col-sm-12">
											...
											<input type="text" class="form-control @error('model_name') border-danger @enderror" id="exampleFormControlInput1" value="{{old('model_name',$data->model_name)}}" placeholder="Enter Model Name" name="model_name">
											@error('model_name')
