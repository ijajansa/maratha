					...
					<div class="nk-block nk-block-lg">
						<div class="nk-block-head">
							...
							<div class="nk-block-head-content">
								<h4 class="title nk-block-title">Add New Store</h4>
						...
						<div class="card card-bordered">
							<div class="card-inner">
								...
								<form method="post" enctype="multipart/form-data" action="{{url('stores/add')}}">
									...
									<div class="row g-4">
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input type="text" class="form-control @error('store_name') is-invalid @enderror" id="exampleFormControlInput1" value="{{old('store_name')}}" placeholder="Enter Store Name" name="store_name">
												@error('store_name')
										...
										<div class="col-xl-6 col-sm-6">
											...
											<input type="number" class="form-control @error('store_contact_number') is-invalid @enderror" id="exampleFormControlInput6" value="{{old('store_contact_number')}}" placeholder="Enter Contact Number" name="store_contact_number">
										...
										<!--	<input type="text" class="form-control @error('store_gstin_number') is-invalid @enderror" id="exampleFormControlInput6" value="{{old('store_gstin_number')}}" placeholder="Enter GSTIN Number" name="store_gstin_number">-->
										...
										<div class="col-xl-6 col-sm-6">
											...
											<input type="text" class="form-control @error('address') is-invalid @enderror" id="search_input" autocomplete="off" placeholder="Enter Address" name="address" onkeyup="getLatLang(this.value)" onselect="getLatLang(this.value)">
											@error('address')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
										...
										<div class="col-xl-6 col-sm-6">
											...
											<input type="text" class="form-control @error('store_url') is-invalid @enderror" id="search_input1" autocomplete="off" placeholder="Enter Google Map URL" value="{{old('store_url')}}" name="store_url">
											@error('store_url')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
										...
										<div class="col-xl-6 col-sm-6">
											<label for="exampleFormControlInput10" class="form-label text-primary">Store Photo <span class="required">*</span></label>
