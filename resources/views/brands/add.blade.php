					...
					<div class="nk-block nk-block-lg">
						<div class="nk-block-head">
							...
							<div class="nk-block-head-content">
								<h4 class="title nk-block-title">Add New Brand</h4>
						...
						<div class="card card-bordered">
							<div class="card-inner">
								...
								<form method="post" enctype="multipart/form-data" action="{{url('brands/add')}}">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="form-control-wrap">
													<input type="text" id="demo-text-input" name="brand_name" class="form-control form-control-md @error('brand_name') is-invalid @enderror" placeholder="Enter Brand Name" value="{{old('brand_name')}}" />
													@error('brand_name')
													<span class="invalid-feedback" role="alert">
														<strong>{{ $message }}</strong>
													</span>
