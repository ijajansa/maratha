					...
					<div class="nk-block nk-block-lg">
						<div class="nk-block-head">
							...
							<div class="nk-block-head-content">
								<h4 class="title nk-block-title">Add New Bike</h4>
						...
						<div class="card card-bordered">
							<div class="card-inner">
								...
								<form method="post" enctype="multipart/form-data" action="{{url('bikes/add')}}">
									...
									<div class="row g-4">
                                        ...
                                        <div class="col-lg-4">
											<div class="form-group">
												...
												<div class="form-control-wrap">
													<input type="text" id="demo-text-input" name="registration_number" class="form-control form-control-md @error('registration_number') is-invalid @enderror" placeholder="Enter Vehicle Registration Number" value="{{old('registration_number')}}" />
                                        ...
                                        <div class="col-lg-4">
											<div class="form-group">
												...
												<div class="form-control-wrap">
													<input type="text" id="demo-text-input" name="chassis_number" class="form-control form-control-md @error('chassis_number') is-invalid @enderror" placeholder="Enter Vehicle Chassis Number" value="{{old('chassis_number')}}" />
										...
										<div class="col-lg-4">
											<div class="form-group">
												...
												<div class="form-control-wrap">
													<input type="text" id="demo-text-input" name="engine_number" class="form-control form-control-md @error('engine_number') is-invalid @enderror" placeholder="Enter Vehicle Engine Number" value="{{old('engine_number')}}" />
													@error('engine_number')
													<span class="invalid-feedback" role="alert">
														<strong>{{ $message }}</strong>
													</span>
										...
										<div class="col-lg-4">
											<div class="preview-block">
											    ...
											    <div class="custom-control custom-switch checked">
											        <input type="checkbox" name="is_puc" class="custom-control-input" checked="" id="customSwitch2">
										...
										<div class="col-lg-4">
											<div class="preview-block">
											    ...
											    <div class="custom-control custom-switch checked">
											        <input type="checkbox" name="is_insurance" class="custom-control-input" checked="" id="customSwitch3">
										...
										<div class="col-lg-4">
											<div class="preview-block">
											    ...
											    <div class="custom-control custom-switch checked">
											        <input type="checkbox" name="is_document" class="custom-control-input" checked="" id="customSwitch4">
										...
										<div class="col-xl-12 col-sm-12">
											...
											<input type="file" class="form-control @error('image') is-invalid @enderror" id="imageUpload" value="{{old('image')}}" name="image[]" multiple  accept=".png, .jpg, .jpeg">
											@error('image')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
