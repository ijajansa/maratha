					...
					<div class="nk-block nk-block-lg">
						...
						<div class="card card-bordered">
							<div class="card-inner">
								...
								<form method="post" action="{{url('prices/add')}}">
									...
									<div class="row g-4">
										...
										<div class="col-xl-4 col-sm-4">
											...
											<!--<input type="number" min="1" max="365" class="form-control @error('days') is-invalid @enderror" id="search_input1" autocomplete="off" placeholder="Enter Number of Days" name="days" value="{{old('days')}}">-->
											<select class="form-control form-select @error('days') is-invalid @enderror" id="search_input1" name="days" value="{{old('days')}}">
											    ...
											    <option value="1" @if(old('days')==1) selected @endif>1 Day</option>
											    <option value="7" @if(old('days')==7) selected @endif>7 Days</option>
											    <option value="15" @if(old('days')==15) selected @endif>15 Days</option>
											    <option value="30" @if(old('days')==30) selected @endif>30 Days</option>
											</select>
											@error('days')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
										...
										<div class="col-xl-4 col-sm-4">
											...
											<input type="number" min="0" class="form-control @error('deposit') is-invalid @enderror" id="search_input3" autocomplete="off" placeholder="Enter Deposit Amount" name="deposit" value="{{old('deposit')}}">
											@error('deposit')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
										...
										<!-- <div class="col-xl-4 col-sm-4">
											...
											<input type="number" min="0" class="form-control @error('hourly_charge_amount') is-invalid @enderror" id="search_input3" autocomplete="off" placeholder="Enter Hourly Charged Amount" name="hourly_charge_amount" value="{{old('hourly_charge_amount')}}">
