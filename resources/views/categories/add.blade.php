					...
					<div class="nk-block nk-block-lg">
						<div class="nk-block-head">
							...
							<div class="nk-block-head-content">
								<h4 class="title nk-block-title">Add New Category</h4>
						...
						<div class="card card-bordered">
							<div class="card-inner">
								...
								<form method="post" enctype="multipart/form-data" action="{{url('categories/add')}}">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="form-control-wrap">
													<input type="text" id="demo-text-input" name="category_name" class="form-control form-control-md @error('category_name') is-invalid @enderror" placeholder="Enter Category Name" value="{{old('category_name')}}" />
													@error('category_name')
